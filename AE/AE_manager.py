...
class Manager():
    def __init__(self, file_pth='experiments/misc', num_epochs=20, batch_size=15, shuffle=True, lr=0.001, weight_decay=0.01,
        ...
        train_set                       = signal_dataset.SignalDataset('data', True, 'train', distribution , filtering=filtering, cropping=cropping, normalise=normalise, augment=augment)
        test_set                        = signal_dataset.SignalDataset('data', True, 'test', distribution , filtering=filtering, cropping=cropping, normalise=normalise, augment=False)
        val_set                         = signal_dataset.SignalDataset('data', True, 'val', distribution , filtering=filtering, cropping=cropping, normalise=normalise, augment=False)
